...
public abstract class BankAccount {
    ...
    private final List<Integer> proxies;
    ...
    protected void addInterestPercent(BigDecimal percent) {
        // percent can be lower then zero
        this.balance = this.balance.add(this.balance.multiply(percent));
    }
